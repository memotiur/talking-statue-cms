...
@section('content')
    <div class="page-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> New Template</h1>
        </div>
        <div>
            <ul class="breadcrumb">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="login-form" method="post" action="/admin/save-template"
                                      enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="control-label">Template Name</label>
                                        <input class="form-control" type="text" placeholder="Template name"
                                               name="templates_name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" type="text" placeholder="Template Description"
                                                  name="templates_description" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img id="blah2" src="#" alt="Image" width="150px"/>
                                            </div>
                                        </div>
